        ...
        if (characterObject.nearestObject === 'Coordonnées' || characterObject.nearestObject === 'Skills' || characterObject.nearestObject === 'Parcours' || characterObject.nearestObject === 'Projets') {
            ...
            switch (characterObject.nearestObject) {
                ...
                case "phone":
                    ...
                    document.querySelector('#EEContent').innerHTML = '<iframe width="560" height="315" src="https://manno-pascal.github.io/pacman/" frameborder="0"></iframe>'
                    break;
                case "tv":
                    document.querySelector("#easterEggs").style.display = "flex"
                    document.querySelector('#EEContent').innerHTML = '<iframe width="560" height="315" src="https://www.youtube.com/embed/SXHMnicI6Pg?si=UFf-BIsGcuf60h1O&autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>'
                    break;
                case "yolo":
                    document.querySelector("#easterEggs").style.display = "flex"
                    document.querySelector('#EEContent').innerHTML = '<img height="315" src="./src/img/brendan.png" ></img>'
                    break;
